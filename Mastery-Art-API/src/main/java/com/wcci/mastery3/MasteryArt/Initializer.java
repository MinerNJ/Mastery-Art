...
public class Initializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		artist2.addArtToArtist(art2);
		artist3.addArtToArtist(art3);
		artistRepo.save(artist1);
		artistRepo.save(artist2);
		artistRepo.save(artist3);

		Description description1 = new Description("Photo");
		Description description2 = new Description("Canvas");
		Description description3 = new Description("Statue");
		art1.addDescription(description1);
		art2.addDescription(description2);
		art3.addDescription(description3);
		artRepo.save(art1);
		artRepo.save(art2);
		artRepo.save(art3);
